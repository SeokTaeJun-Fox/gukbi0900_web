...
let beforeChangeNumberType = 1.7;
let afterChangeNumberType = parseInt(beforeChangeNumberType);
let result = beforeChangeNumberType === afterChangeNumberType ? "정수입니다." : "실수입니다.";
console.log(result);
